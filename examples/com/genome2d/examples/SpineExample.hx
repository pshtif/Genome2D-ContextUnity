...
class SpineExample extends AbstractExample
{
    ...
    override public function initExample():Void {		
		...
		spine.setup(GStaticAssetManager.getTextAssetById("assets/spine/spineboy/spineboy-old.txt").text, GTextureManager.getTexture("spineboy"));
        spine.getSpine().addSkeleton("default", GStaticAssetManager.getTextAssetById("assets/spine/spineboy/spineboy-old-skeleton.json").text);
